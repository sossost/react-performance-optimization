...
export default function App() {
  ...
  // debounce 함수 사용 (lodash-es에서 필요한 함수만 번들에 포함됨)
    ...
    <div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        ...
        <p style={{ margin: 0, color: "#047857" }}>
          lodash-es에서 필요한 함수(debounce)만, date-fns에서 필요한 함수(format)만
          번들에 포함되어 있습니다.
          <br />
          사용하지 않는 코드는 번들에서 제거됩니다.
          <br />
      ...
      >
        ...
        <p style={{ margin: 0, color: "#1e40af" }}>
          ...
          <br />
          Before 프로젝트와 비교하여 번들 크기가 현저히 줄어든 것을 확인할 수
          있습니다.
        </p>
      </div>
    </div>
