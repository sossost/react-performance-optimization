...
- 본 실습의 연산 강도는 **일치한 항목에만 적용**되어 랜덤 입력은 상대적으로 덜 느릴 수 있음
...
- 접속: [http://localhost:5186](http://localhost:5186)
- 입력을 빠르게 변경하면서 Before/After의 응답성을 비교하세요.
...
- 의미 있는 검색어(예: "작업 3")와 랜덤 입력을 번갈아 입력해 차이를 확인
